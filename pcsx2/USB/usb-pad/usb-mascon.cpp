		...
		switch (subtype)
		{
			...
			case MT_RYOJOUHEN:
			{
				static constexpr const InputBindingInfo bindings[] = {
					...
					{"Left", TRANSLATE_NOOP("Pad", "D-Pad Left"), ICON_PF_DPAD_LEFT, InputBindingInfo::Type::Button, CID_MC_LEFT, GenericInputBinding::DPadLeft},
					{"Right", TRANSLATE_NOOP("Pad", "D-Pad Right"), ICON_PF_DPAD_RIGHT, InputBindingInfo::Type::Button, CID_MC_RIGHT, GenericInputBinding::DPadRight},
					{"Announce", TRANSLATE_NOOP("Pad", "Announce"), ICON_PF_KEY_B, InputBindingInfo::Type::Button, CID_MC_A, GenericInputBinding::Circle},
					{"Horn", TRANSLATE_NOOP("Pad", "Horn"), ICON_PF_KEY_A, InputBindingInfo::Type::Button, CID_MC_B, GenericInputBinding::Cross},
					{"LeftDoor", TRANSLATE_NOOP("Pad", "Left Door"), ICON_PF_KEY_L, InputBindingInfo::Type::Button, CID_MC_L, GenericInputBinding::Square},
					{"RightDoor", TRANSLATE_NOOP("Pad", "Right Door"), ICON_PF_KEY_R, InputBindingInfo::Type::Button, CID_MC_R, GenericInputBinding::Triangle},
					{"Camera", TRANSLATE_NOOP("Pad", "Camera Button"), ICON_PF_CAMERA, InputBindingInfo::Type::Button, CID_MC_CAMERA, GenericInputBinding::R1},
					{"Select", TRANSLATE_NOOP("Pad", "Select"), ICON_PF_SELECT_SHARE, InputBindingInfo::Type::Button, CID_MC_SELECT, GenericInputBinding::Select},
					{"Start", TRANSLATE_NOOP("Pad", "Start"), ICON_PF_START, InputBindingInfo::Type::Button, CID_MC_START, GenericInputBinding::Start},
				};
...
#define get_cd(buttons) (button_at(buttons, CID_MC_C) | button_at(buttons, CID_MC_D))
...
#define get_ss(buttons) (button_at(buttons, CID_MC_START) | button_at(buttons, CID_MC_SELECT))
	...
	{
		return (get_ab(buttons) | (button_at(buttons, CID_MC_CAMERA) >> 4) | ((get_cd(buttons) | get_ss(buttons)) << 1));
	}
